        ...
        <div class="container">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6  ">
                        ...
                        <div class="card-body" >
                            <div>
                                <img src="./img/sign.jpg"  alt="Sign Image" class="img-fluid"  />
                            </div>
                    ...
                    <div class="card shadow-lg p-3 mb-3 bg-body-tertiary rounded">
                        <div class="card-body px-5 ">
                            ...
                            <form action="Register" method="post">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <input type="text" placeholder="user Phone" class="form-control" name="userPhone" aria-describedby="User Phone" maxlength="10" pattern="[0-9]{1,10}" title="Only Number characters allowed, up to 10 characters" required="">
                                ...
                                <div class="form-group">
                                    <div class="mb-3">
                                        <textarea style="height: 80px" class="form-control" placeholder="user Address" name="userAddress" ></textarea>
